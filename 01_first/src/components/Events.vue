<template>
    <div>
        ...
        <p>
            잔액은 <span v-text="balance"></span>만원 입니다.
        </p>

        <h4>2) 기본 이벤트</h4>

        <!-- <a @contextmenu="(event) => event.preventDefault()" href="https://www.naver.com">네이버로</a> -->
        ...
        <button @contextmenu.prevent
                @click.left="name = '홍길동'"
                @click.right="name = ''"
                @click.ctrl.left="name = '이몽룡'"
                @click.ctrl.right="name = '성춘향'">버튼 클릭</button>
